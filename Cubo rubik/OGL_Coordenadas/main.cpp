...
int main()
{
    ...
    //nadamas logre hacer que se pudiera ver 1 sola cara profe perdon
    unsigned char* data = stbi_load("C:\\gl\\resources\\textures\\solo cara de rubik.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
